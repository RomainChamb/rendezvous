...
[36m@@ -11,4 +11,6 @@[m [mpublic interface Calendrier {[m
     boolean reserverRendezVous(Creneau creneau);[m
 [m
     boolean isCreneauDisponible(Creneau creneau);[m
[32m+[m
[32m+[m[32m    boolean isCreneauReserve(String nomDuPatient, Creneau creneau);[m
 }[m
...
[36m@@ -40,4 +40,9 @@[m [mpublic class InMemoryCalendrier implements Calendrier {[m
     public boolean isCreneauDisponible(Creneau creneau) {[m
         return creneaux.contains(creneau);[m
     }[m
[32m+[m
[32m+[m[32m    @Override[m
[32m+[m[32m    public boolean isCreneauReserve(String nomDuPatient, Creneau creneau) {[m
...
[36m@@ -26,4 +26,8 @@[m [mpublic class Reservation {[m
     public boolean isCreneauDisponible(Creneau creneau) {[m
         return calendrier.isCreneauDisponible(creneau);[m
     }[m
[32m+[m
[32m+[m[32m    public boolean isCreneauReserve(String nomDuPatient, Creneau creneau) {[m
[32m+[m[32m        return calendrier.isCreneauReserve(nomDuPatient, creneau);[m
[32m+[m[32m    }[m
 }[m
...
[36m@@ -54,8 +54,11 @@[m [mpublic class PriseDeRendezVousSteps {[m
         assertThat(reservation.isCreneauDisponible(creneau)).isFalse();[m
     }[m
 [m
...
[32m+[m[32m        Creneau creneau = new Creneau(date, heure);[m
[32m+[m[32m        reservation.prendreRendezVous(creneau);[m
[32m+[m[32m        assertThat(reservation.isCreneauReserve(nomDuPatient,creneau)).isTrue();[m
...
[36m@@ -54,5 +54,4 @@[m [mclass ReservationTest {[m
         // THEN[m
         assertThat(reservation.prendreRendezVous(creneau)).isFalse();[m
     }[m
[31m-[m
 }[m
